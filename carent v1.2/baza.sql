...
--
-- Host: 127.0.0.1
-- Czas generowania: 05 Lut 2022, 14:43
...
('root', '[{\"db\":\"samochody\",\"table\":\"klienci\"},{\"db\":\"samochody\",\"table\":\"auta\"},{\"db\":\"samochody\",\"table\":\"zam\\u00f3wienia\"}]');
...
('root', '2022-02-05 13:42:49', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
...
--
CREATE DATABASE IF NOT EXISTS `samochody` DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci;
USE `samochody`;
...
INSERT INTO `auta` (`IDSamochodu`, `Nazwa`, `Cena`) VALUES
(1, 'Porsche 911', 1200),
(2, 'AUDI RS5 Quattro', 750),
(3, 'BMW serii 8', 800),
(4, 'DODGE Challenger', 900),
(5, 'JAGUAR F-Type', 1000),
(6, 'LEXUS RC', 900);
...
INSERT INTO `klienci` (`IDKlienta`, `Imie`, `Nazwisko`, `Mail`, `Telefon`) VALUES
(1, 'Jan', 'Dąbrowski', 'siema@wp.pl', 1231232133),
(2, 'Jan', 'Dąbrowski', 'siema@wp.pl', 1231232133),
(3, 'Jan', 'Dąbrowski', 'siema@wp.pl', 123332121);
...
CREATE TABLE `zamówienia` (
  ...
  `IDSamochodu` int(11) NOT NULL,
  `IDKlienta` int(11) NOT NULL,
  `DataWypożyczenia` date DEFAULT NULL,
  `CzasWypożyczenia` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
--
ALTER TABLE `auta`
  MODIFY `IDSamochodu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `zamówienia`
  MODIFY `IDZamówienia` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `zamówienia`
  ADD CONSTRAINT `zamówienia_ibfk_1` FOREIGN KEY (`IDSamochodu`) REFERENCES `auta` (`IDSamochodu`),
  ADD CONSTRAINT `zamówienia_ibfk_2` FOREIGN KEY (`IDKlienta`) REFERENCES `klienci` (`IDKlienta`);
--
-- Baza danych: `test`
--
